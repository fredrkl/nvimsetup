...
This neovim setup works well with [tmux](https://github.com/tmux/tmux/wiki). I have created a [tmux-conf](https://github.com/fredrkl/tmux-conf) that works well with this neovim setup.
